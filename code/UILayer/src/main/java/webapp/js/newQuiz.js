...
function closePop(option) {
	...
	if (option == 1) {
		...
		document.getElementById("questions").innerHTML += '<div>' +
			...
			'</div><div><input type="radio" name="answerM" value="ans2" id="2Ans' + contatore + '" /><p class="p-answer"> Answer #2</p><textarea class="TextQuestion other-display" rows="2" cols="100">' +
			'</textarea></div><div><input type="radio" id="3Ans' + contatore + '" name="answerM" value="ans3" checked /><p class="p-answer"> Answer #3</p>' +
			'<textarea class="TextQuestion other-display" rows="2" cols="100"></textarea></div><div><input type="radio" id="4Ans' + contatore + '" name="answerM" value="ans4" />' +
