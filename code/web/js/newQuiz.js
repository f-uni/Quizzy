...
function checkOpt(opt){
    ...
    if(opt=="QuestVF"){
        ...
        if(document.getElementById("1Ans"+contatore).checked){
            radioCheck = document.getElementById("1Ans"+contatore).innerText.slice(0,-1);
        }
        if(document.getElementById("1Ans"+contatore).checked){
            radioCheck = document.getElementById("2Ans"+contatore).innerText.slice(0,-1);
        }
        if(document.getElementById("1Ans"+contatore).checked){
            radioCheck = document.getElementById("3Ans"+contatore).innerText.slice(0,-1);
        }
        else{
            radioCheck = document.getElementById("4Ans"+contatore).innerText.slice(0,-1);
        }
    }
    return radioCheck;
}
...
function deleteQuest2(id){
    ...
    for(var j=1; j<(quest.length) ; j++){
        document.getElementById("titleQ"+(j+1)).textContent.replace("Question"+(j+1),"Question22"+(j));
    }
}
